...
string get_current_dir()
{
    ...
    // TODO: Add a condition to check for () and add \ before
...
void fill_out()
{
    vector<string> replace_rdme;
    replace_rdme.push_back("github_username");
    replace_rdme.push_back("repo");
    replace_rdme.push_back("twitter_handle");
    replace_rdme.push_back("email");

    for (int i = 0; i < replace_rdme.size(); i++)
    {
        cout << replace_rdme[i];
    }
